        ...
        <div className='homeWrap'>
          <div className='homeWrap1'>
            <div className='wrapTop1'>
              <a href='detail'><img src='../img/duan1.jpg' alt=''></img></a>
              <p>Tên công trình</p>
            </div>
            <div className='wrapbottom1'>
              <a href='detail'><img src='../img/duan2.jpg' alt=''></img></a>
               <p>Tên công trình</p>
            </div>
          </div>
          <div className='homeWrap2'>
            <div className='wrapTop2'>
              <a href='detail'><img src='../img/duan3.jpg' alt=''></img></a>
              <p>Tên công trình</p>
            </div>
            <div className='wrapMid2'>
              <a href='detail'><img src='../img/duan4.jpg' alt=''></img></a>
              <p>Tên công trình</p>
            </div>
